...
*keep if plancode==1 | plancode==90
...
save col_1989_2014_aph, replace
...
*keep if insurance_plan==1 | insurance_plan==90
...
merge 1:1 year statecode countycode cropcode using "col_1989_2014_aph.dta"
...
save Dryland1989_2014_`gs'_aph.dta, replace
restore
...
cd "/Users/jisangyu/Dropbox/RMA_cause_of_loss/data_jisang"
local gs apr_sep
use Dryland1989_2014_`gs'_aph.dta
...
save ddayreg_89_2014_`gs'_aph.dta, replace
