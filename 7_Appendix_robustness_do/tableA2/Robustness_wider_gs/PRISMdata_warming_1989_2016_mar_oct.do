...
foreach s of local stateList {;
    * loop over years;
    forvalues t = `yearMin'/`yearMax' {;
		...
		*WARMING SCENARIO: increase the min/max, all else the same;
            ...
            * save data;
            if (`appendID' > 0) {;
	            *append using "\\tsclient\(root)\Users\jisangyu\Documents\PRISM_raw\PRISM_1989_2016_`gs'.dta";
				append using "/Users/jisangyu/Dropbox/PRISM/PRISM_1989_2016_v2plus1_`gs'.dta";
	        };
	        local appendID = 1;
            sort fips year;
            *qui save "\\tsclient\(root)\Users\jisangyu\Documents\PRISM_raw\PRISM_1989_2016_`gs'.dta", replace;
			qui save "/Users/jisangyu/Dropbox/PRISM/PRISM_1989_2016_v2plus1_`gs'.dta", replace;
        };
    };
};
* clear up files;
...
save "/Users/jisangyu/Dropbox/PRISM/PRISM_1989_2016_v2plus1_`gs'", replace;
